            ...
            <div className="hidden lg:flex items-center gap-4">
              <div className="text-right leading-tight">
                <a
                  ...
                  className="flex items-center gap-1.5 text-orange-400 font-oswald font-medium hover:text-orange-300 transition-colors text-sm justify-end"
                >
              ...
              <button
                ...
                onClick={() =>
                  lead.open({
                    ...
                    subtitle: "Бесплатный замер столбов в день обращения.",
                  })
                }
              >
                Вызвать замерщика
